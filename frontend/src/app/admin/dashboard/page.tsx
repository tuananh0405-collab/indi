      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={exporting}
            className="flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors disabled:opacity-50"
          >
            {exporting ? (
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5">
          ...
          {statsLoading ? (
            ...
            <p className="text-2xl font-bold text-gray-900">
              VND {formatCurrency(stats?.totalRevenue ?? 0)}
            </p>
          )}
        </div>
        <div className="bg-white rounded-xl border border-gray-100 p-5">
                ...
                tickets.map((ticket, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 font-mono text-xs text-gray-700" title={ticket.uuid}>
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`inline-flex px-2 py-0.5 rounded-full text-xs font-medium ${TICKET_TYPE_COLORS[ticket.ticketType] || 'bg-gray-100 text-gray-700'}`}
                        >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`inline-flex px-2 py-0.5 rounded-full text-xs font-medium ${TICKET_STATUS_COLORS[ticket.status] || 'bg-gray-100 text-gray-500'}`}
                        >
                          {TICKET_STATUS_LABELS[ticket.status] || ticket.status}
                        </span>
                      </td>
                      <td className="px-4 py-3 text-gray-500 max-w-[140px] truncate" title={ticket.notes}>
                        {ticket.notes || '—'}
                      </td>
                      <td className="px-4 py-3">
